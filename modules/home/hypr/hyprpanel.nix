    ...
    programs.hyprpanel = {
      ...
      layout = {
        "bar.layouts" = {
          "0" = {
            ...
            middle = [ "media" ];
            right = [ "systray" "bluetooth" "volume" "network" "clock" "battery" "notifications" ];
          };
        };
      };
     ...
     settings = {
      ...
      override = {
        ...
        theme.bar.menus.menu.clock.weather.hourly.temperature = "#${red}";
        theme.bar.menus.menu.clock.weather.hourly.icon = "#${red}";
        theme.bar.menus.menu.clock.weather.hourly.time = "#${red}";
        ...
        theme.bar.menus.menu.clock.weather.stats = "#${red}";
        theme.bar.menus.menu.clock.weather.status = "#${green}";
        theme.bar.menus.menu.clock.weather.temperature = "#${foreground}";
        theme.bar.menus.menu.clock.weather.icon = "#${red}";
        theme.bar.menus.menu.clock.calendar.contextdays = "#${grey}";
        theme.bar.menus.menu.clock.calendar.days = "#${foreground}";
        theme.bar.menus.menu.clock.calendar.currentday = "#${red}";
        theme.bar.menus.menu.clock.calendar.paginator = "#${red}";
        theme.bar.menus.menu.clock.calendar.weekdays = "#${red}";
        theme.bar.menus.menu.clock.calendar.yearmonth = "#${red}";
        theme.bar.menus.menu.clock.time.timeperiod = "#${red}";
        theme.bar.menus.menu.clock.time.time = "#${red}";
        theme.bar.menus.menu.clock.text = "#${foreground}";
        theme.bar.menus.menu.clock.border.color = "#${red}";
        ...
        theme.bar.menus.menu.battery.slider.primary = "#${magenta}";
        theme.bar.menus.menu.battery.icons.active = "#${magenta}";
        theme.bar.menus.menu.battery.icons.passive = "#${foreground}";
        theme.bar.menus.menu.battery.listitems.active = "#${magenta}";
        theme.bar.menus.menu.battery.listitems.passive = "#${foreground}";
        theme.bar.menus.menu.battery.text = "#${foreground}";
        theme.bar.menus.menu.battery.label.color = "#${magenta}";
        theme.bar.menus.menu.battery.border.color = "#${magenta}";
        ...
        theme.bar.menus.menu.network.iconbuttons.active = "#${orange}";
        theme.bar.menus.menu.network.iconbuttons.passive = "#${foreground}";
        theme.bar.menus.menu.network.icons.active = "#${orange}";
        theme.bar.menus.menu.network.icons.passive = "#${foreground}";
        theme.bar.menus.menu.network.listitems.active = "#${orange}";
        ...
        theme.bar.menus.menu.network.label.color = "#${orange}";
        theme.bar.menus.menu.network.border.color = "#${orange}";
        ...
        theme.bar.menus.menu.volume.input_slider.primary = "#${yellow}";
        ...
        theme.bar.menus.menu.volume.audio_slider.primary = "#${yellow}";
        theme.bar.menus.menu.volume.icons.active = "#${yellow}";
        theme.bar.menus.menu.volume.icons.passive = "#${foreground}";
        theme.bar.menus.menu.volume.iconbutton.active = "#${yellow}";
        theme.bar.menus.menu.volume.iconbutton.passive = "#${foreground}";
        theme.bar.menus.menu.volume.listitems.active = "#${yellow}";
        theme.bar.menus.menu.volume.listitems.passive = "#${foreground}";
        theme.bar.menus.menu.volume.text = "#${foreground}";
        theme.bar.menus.menu.volume.label.color = "#${yellow}";
        theme.bar.menus.menu.volume.border.color = "#${yellow}";
        ...
        theme.bar.buttons.clock.icon_background = "#${red}";
        theme.bar.buttons.clock.icon = "#${background}";
        theme.bar.buttons.clock.text = "#${red}";
        theme.bar.buttons.clock.background = "#${darkgrey}";
        theme.bar.buttons.battery.icon_background = "#${magenta}";
        theme.bar.buttons.battery.icon = "#${background}";
        theme.bar.buttons.battery.text = "#${magenta}";
        ...
        theme.bar.buttons.network.icon_background = "#${orange}";
        theme.bar.buttons.network.icon = "#${background}";
        theme.bar.buttons.network.text = "#${orange}";
        theme.bar.buttons.network.background = "#${darkgrey}";
        theme.bar.buttons.volume.icon_background = "#${yellow}";
        theme.bar.buttons.volume.icon = "#${background}";
        theme.bar.buttons.volume.text = "#${yellow}";

...
-- Type: [Style](https://xplr.dev/en/style)
xplr.config.general.focus_ui.style = { fg = "Green", add_modifiers = { "Bold" } }
...
--
-- Type: nullable string
xplr.config.general.panel_ui.help_menu.title.format = "Help"
...
--
-- Type: nullable string
xplr.config.general.panel_ui.input_and_logs.title.format = "Input"
...
xplr.fn.builtin.fmt_general_table_row_cols_1 = function(m)
    ...
    local function path_escape(path)
        ...
        if string.len(escaped) > 21 then
            escaped = string.sub(escaped, 0, 18) .. "..."
        end
